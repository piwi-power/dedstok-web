...
const ROOMS = [
  { index: '01', name: 'LOBBY',            desc: 'The entrance',              href: '/' },
  { index: '02', name: 'DROP ROOM',        desc: "This week's drop",          href: '/drops' },
  { index: '03', name: 'HALL OF RECORDS',  desc: 'Top earners, all time',     href: '/leaderboard' },
  { index: '04', name: 'THE ARCHIVE',      desc: 'Every winner. Every drop.', href: '/winners' },
  { index: '05', name: 'THE EDIT',         desc: 'Culture & stories',         href: '/articles' },
]
