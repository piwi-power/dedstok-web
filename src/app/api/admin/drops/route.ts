...
export async function POST(request: NextRequest) {
  ...
  const { item_name, description, entry_price, total_spots, draw_date, market_value, sourcing_tier, status } = body
...
export async function PATCH(request: NextRequest) {
  ...
  const allowed = ['item_name', 'slug', 'description', 'entry_price', 'total_spots', 'draw_date', 'market_value', 'sourcing_tier', 'status']
